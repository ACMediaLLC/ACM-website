          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mt-12">
              <div className="bg-seashell p-8 rounded-lg border-2 border-brick-red">
                <h3 className="font-roboto-condensed font-bold text-2xl bg-gradient-to-r from-brick-red to-rose-500 bg-clip-text text-transparent mb-4 text-center" style={{filter: 'drop-shadow(0 0 15px rgba(232, 93, 111, 0.25))'}}>
                  What to Expect
                </h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <p className="font-roboto text-neutral leading-relaxed">
                      <span className="font-semibold text-text-primary">Quick Response:</span>  Check your inbox for a link to claim your spot on my calendar
                    </p>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-brick-red mt-1">•</span>
